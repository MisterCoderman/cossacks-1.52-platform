...
{
	// 1) ��� �������
	const int cap = INT_MAX / 2;      // ���������� ��������
	for (int i = 0; i < 6; ++i)
	{
		int cur = XRESRC(NI, i);      // ������� ���������� ������� :contentReference[oaicite:0]{index=0}:contentReference[oaicite:1]{index=1}
		int toAdd = cap - cur;
		if (toAdd > 0)
