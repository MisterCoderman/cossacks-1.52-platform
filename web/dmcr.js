...
// include: C:\Users\Oleg\AppData\Local\Temp\tmp4x6xrhs9.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/cossacks_wasm/web/dmcr.data';
      var REMOTE_PACKAGE_BASE = 'dmcr.data';
...
Module['FS_createPath']("/", "ai", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_C:/cossacks_wasm/web/dmcr.data');
      }
      Module['addRunDependency']('datafile_C:/cossacks_wasm/web/dmcr.data');
    ...
    loadPackage({"files": [{"filename": "/ai/Algeria.dll", "start": 0, "end": 57344}, {"filename": "/ai/Austria.dll", "start": 57344, "end": 151552}, {"filename": "/ai/Bavaria.dll", "start": 151552, "end": 245760}, {"filename": "/ai/Denmark.dll", "start": 245760, "end": 294912}, {"filename": "/ai/England.dll", "start": 294912, "end": 389120}, {"filename": "/ai/France.dll", "start": 389120, "end": 483328}, {"filename": "/ai/German.dll", "start": 483328, "end": 577536}, {"filename": "/ai/Holland.dll", "start": 577536, "end": 671744}, {"filename": "/ai/Piemont.dll", "start": 671744, "end": 765952}, {"filename": "/ai/Poland.dll", "start": 765952, "end": 860160}, {"filename": "/ai/Portugalia.dll", "start": 860160, "end": 954368}, {"filename": "/ai/Russia.dll", "start": 954368, "end": 1048576}, {"filename": "/ai/Saksinia.dll", "start": 1048576, "end": 1142784}, {"filename": "/ai/Spain.dll", "start": 1142784, "end": 1236992}, {"filename": "/ai/Sveden.dll", "start": 1236992, "end": 1331200}, {"filename": "/ai/Switzerland.dll", "start": 1331200, "end": 1425408}, {"filename": "/ai/Turcia.dll", "start": 1425408, "end": 1495040}, {"filename": "/ai/Ukraine.dll", "start": 1495040, "end": 1548288}, {"filename": "/ai/Venecia.dll", "start": 1548288, "end": 1642496}, {"filename": "/ai/Vengria.dll", "start": 1642496, "end": 1736704}], "remote_package_size": 1736704});

  })();

// end include: C:\Users\Oleg\AppData\Local\Temp\tmp4x6xrhs9.js
// include: C:\Users\Oleg\AppData\Local\Temp\tmpd1032u1k.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Oleg\AppData\Local\Temp\tmpd1032u1k.js
// include: C:\Users\Oleg\AppData\Local\Temp\tmp_cd4z9q4.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Oleg\AppData\Local\Temp\tmp_cd4z9q4.js
...
/** @type {function(string, boolean=, number=)} */
  ...
  function _cos_data_init() { return 0; }
  ...
  function _cos_fetch_file(canonPtr) {
  ...
  function _cos_persist_soon() { COS_DATA_STATE.persistSoon(); }
  ...
  function _cosa_free(h) { delete COS_AUDIO.bufs[h]; }

  function _cosa_halt(c) { COS_AUDIO.stop(c); }

  function _cosa_init(rate) { return COS_AUDIO.ensure() ? 0 : -1; }

  function _cosa_load_pcm16(ptr, frames, channels, rate) {
  ...
  function _cosa_music_active(musicCh) {
      var m = COS_AUDIO.ch[musicCh];
      return ((m && m.playing) || COS_AUDIO.musicBusy) ? 1 : 0;
    }

  function _cosa_music_cancel(musicCh) {
  ...
  function _cosa_music_play(canonPtr, musicCh) {
      var canon = UTF8ToString(canonPtr);
      var A = COS_AUDIO;
  ...
  function _cosa_music_prefetch(canonPtr) {
      var canon = UTF8ToString(canonPtr);
      var A = COS_AUDIO;
  ...
  function _cosa_playing(c) { var m = COS_AUDIO.ch[c]; return (m && m.playing) ? 1 : 0; }

  function _cosa_poll_ended() {
      if (!COS_AUDIO.ended.length) return -1;
      return COS_AUDIO.ended.shift();
    }

  function _cosa_volume(c, v) {
  ...
  function _cosc_connect_start(s) {
      var sock = COS_CHAT.socks[s];
  ...
  function _cosgsc_poll(num) {
      var r = COS_GSC.replies[num];
      return (r === undefined) ? -1 : r.length;
    }

  function _cosgsc_recv(num, bufPtr, cap) {
      var r = COS_GSC.replies[num];
  ...
  function _cosgsc_send(num, ver, lang, payloadPtr, len) {
      COS_GSC.ensure();
  ...
  vip:function (id) { return (10 << 24) | (id & 0xFFFFFF); },
  ...
  function _cosn_close(s) {
      if (COS_NET.useNative() && window.cosElectron) window.cosElectron.udpClose(s);
      delete COS_NET.socks[s];
    }

  function _cosn_gsc_leave() { COS_NET.internetRoom = false; COS_NET.punchMap = {}; }

  
  function _cosn_gsc_room(hostId, punchId, keyPtr, isHost) {
      COS_NET.gscRoom(hostId >>> 0, punchId >>> 0, keyPtr ? UTF8ToString(keyPtr) : '', !!isHost);
    }

  function _cosn_has_native_udp() {
      return (typeof window !== 'undefined' && window.cosElectron && window.cosElectron.udpSocket) ? 1 : 0;
    }

  function _cosn_my_relay_id() { COS_NET.ensureWs(); return COS_NET.myId | 0; }

  function _cosn_recvfrom(s, buf, cap, ipOut, portOut) {
      var k = COS_NET.socks[s]; if (!k) return -1;
  ...
  function _cosn_sendto(s, buf, len, ip, port) {
      var k = COS_NET.socks[s]; if (!k) return -1;
...
var ASM_CONSTS = {
  8582692: () => { return (typeof COS_DATA_STATE!=='undefined' && COS_DATA_STATE.base==='data/ru')?1:0; },  
 8582781: () => { return Math.round(screen.width * (window.devicePixelRatio || 1)); },  
 8582851: () => { return Math.round(screen.height * (window.devicePixelRatio || 1)); },  
 8582922: () => { if (window.cosOnExit) window.cosOnExit(); },  
 8582968: () => { return (document.fullscreenElement||document.webkitFullscreenElement)?1:0; },  
 8583047: () => { return (Module.canvas && Module.canvas.clientWidth ) ? (Module.canvas.clientWidth *(window.devicePixelRatio||1))|0 : 0; },  
 8583171: () => { return (Module.canvas && Module.canvas.clientHeight) ? (Module.canvas.clientHeight *(window.devicePixelRatio||1))|0 : 0; },  
 8583296: ($0) => { window.__cosInGame=$0; try{ document.body.classList.toggle('ingame', !!$0); }catch(e){} },  
 8583388: () => { return Math.round(screen.width * (window.devicePixelRatio || 1)); },  
 8583458: () => { return Math.round(screen.height * (window.devicePixelRatio || 1)); },  
 8583529: () => { return (typeof COS_DATA_STATE !== 'undefined' && COS_DATA_STATE.base === 'data/ru') ? 1 : 0; },  
 8583626: () => { var c=Module.canvas; return c ? c.width : 0; },  
 8583675: () => { var c=Module.canvas; return c ? c.height : 0; },  
 8583725: () => { var c=Module.canvas; return c ? (c.clientWidth||1) : 1; },  
 8583785: () => { var c=Module.canvas; return c ? (c.clientHeight||1) : 1; },  
 8583846: () => { if (!Module.__wrHooked) { Module.__wrHooked = 1; var c = Module.canvas; c.addEventListener('webglcontextlost', function (e) { e.preventDefault(); Module.__wrLost = 1; console.warn('[webgl] context LOST (backgrounded tab?) — will rebuild on restore'); }, false); c.addEventListener('webglcontextrestored', function () { Module.__wrRestored = 1; console.warn('[webgl] context restored — rebuilding pipeline'); }, false); } },  
 8584275: ($0, $1) => { var c=Module.canvas; if (c && (c.width!=$0 || c.height!=$1)){ c.width=$0; c.height=$1; } },  
 8584368: () => { return Module.__wrLost ? 1 : 0; },  
 8584404: () => { Module.__wrLost = 0; Module.__wrRestored = 0; }
};
...
var wasmImports = {
  ...
  /** @export */
  cos_data_init: _cos_data_init,
  /** @export */
  cos_fetch_file: _cos_fetch_file,
  /** @export */
  cos_persist_soon: _cos_persist_soon,
  /** @export */
  cosa_free: _cosa_free,
  /** @export */
  cosa_halt: _cosa_halt,
  /** @export */
  cosa_init: _cosa_init,
  /** @export */
  cosa_load_pcm16: _cosa_load_pcm16,
  /** @export */
  cosa_music_active: _cosa_music_active,
  /** @export */
  cosa_music_cancel: _cosa_music_cancel,
  /** @export */
  cosa_music_play: _cosa_music_play,
  /** @export */
  cosa_music_prefetch: _cosa_music_prefetch,
  /** @export */
  cosa_pan: _cosa_pan,
  /** @export */
  cosa_play: _cosa_play,
  /** @export */
  cosa_playing: _cosa_playing,
  /** @export */
  cosa_poll_ended: _cosa_poll_ended,
  /** @export */
  cosa_volume: _cosa_volume,
  /** @export */
  cosc_connect_poll: _cosc_connect_poll,
  /** @export */
  cosc_connect_start: _cosc_connect_start,
  /** @export */
  cosc_readable: _cosc_readable,
  /** @export */
  cosc_recv: _cosc_recv,
  /** @export */
  cosc_send: _cosc_send,
  /** @export */
  cosc_socket: _cosc_socket,
  /** @export */
  cosgsc_poll: _cosgsc_poll,
  /** @export */
  cosgsc_recv: _cosgsc_recv,
  /** @export */
  cosgsc_send: _cosgsc_send,
  /** @export */
  cosn_bind: _cosn_bind,
  /** @export */
  cosn_close: _cosn_close,
  /** @export */
  cosn_gsc_leave: _cosn_gsc_leave,
  /** @export */
  cosn_gsc_room: _cosn_gsc_room,
  /** @export */
  cosn_has_native_udp: _cosn_has_native_udp,
  /** @export */
  cosn_my_relay_id: _cosn_my_relay_id,
  /** @export */
  cosn_recvfrom: _cosn_recvfrom,
  /** @export */
  cosn_sendto: _cosn_sendto,
  /** @export */
  cosn_set_relay_mode: _cosn_set_relay_mode,
  /** @export */
  cosn_socket: _cosn_socket,
  /** @export */
